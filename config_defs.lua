...
return {
    ...
    { id = 1, key = "pid_kp",         label = "Velocity Kp",     unit = "V/(rad/s)",  default = 0.50, min = 0.0,  max = 50,  step = 0.01 },
    { id = 2, key = "pid_ki",         label = "Velocity Ki",     unit = "V/(rad·s)",  default = 0.10, min = 0.0,  max = 50,  step = 0.01 },
    { id = 3, key = "pid_kd",         label = "Velocity Kd",     unit = "V·s/rad",    default = 0.00, min = 0.0,  max = 50,  step = 0.01 },
    { id = 4, key = "pid_i_limit",    label = "Integral limit",  unit = "V",          default = 10.0, min = 0.0,  max = 24,  step = 0.1  },
    { id = 5, key = "pid_tolerance",  label = "PID tolerance",   unit = "rad/s",      default = 0.05, min = 0.0,  max = 5,   step = 0.01 },
}
