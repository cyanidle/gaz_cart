...
--  renders one editable control per entry).  Keyed by the parameter key; the
--  GUI orders its rows by `id`.
--
...
return {
    wheel_diameter = { id = 0, label = "Wheel diameter", unit = "m",       default = 0.10, min = 0.01, max = 1.0, step = 0.005 },
    pid_kp         = { id = 1, label = "Velocity Kp",     unit = "V/(m/s)", default = 0.50, min = 0.0,  max = 50,  step = 0.01 },
