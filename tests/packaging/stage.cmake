...
if(NOT BUILD_DIR OR NOT STAGE_DIR OR NOT STAGE_DIR STREQUAL "${BUILD_DIR}/packaging-smoke")
    message(FATAL_ERROR "Use the packaging_smoke CTest target")
endif()
file(REMOVE_RECURSE "${STAGE_DIR}")
file(MAKE_DIRECTORY "${STAGE_DIR}/cwd")
foreach(component gaz_cart_runtime gaz_frames gaz_nav gaz_slam)
    execute_process(
...
endforeach()
foreach(path bin/radapter bin/gaz-cart lib/libradapter-sdk.so
